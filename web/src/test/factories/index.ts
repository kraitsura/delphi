...
let idCounter = 0;
const generateId = <T extends string>(prefix: T): Id<T> => {
  idCounter++;
...
export const factories = {
   ...
   */
  roomParticipant: (overrides?: Partial<Doc<"roomParticipants">>): Doc<"roomParticipants"> => {
   ...
   */
  eventMember: (overrides?: Partial<Doc<"eventMembers">>): Doc<"eventMembers"> => {
   ...
   */
  eventInvitation: (overrides?: Partial<Doc<"eventInvitations">>): Doc<"eventInvitations"> => {
