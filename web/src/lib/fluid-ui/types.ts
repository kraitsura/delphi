...
export type SelectionEvent =
	...
	| {
			type: "milestoneSelected";
			payload: { milestoneId: string; milestoneName?: string };
	  }
...
export type ActionEvent =
	...
	| {
			...
			payload: { taskId: string; status: string; updatedBy?: string };
	  }
	| {
			type: "runOfShowUpdated";
			payload: { currentTime: number; currentTaskId?: string };
	  };
