				...
				<TooltipTrigger asChild>
					...
					>
						<Link
							...
							className="block"
						>
							<div className="flex items-start gap-3 w-full min-w-0 group-data-[collapsible=icon]:gap-0 transition-all duration-300 ease-in-out">
								{/* Avatar */}
								...
								{/* Content */}
								<div className="flex-1 min-w-0 space-y-0.5 transition-[opacity,max-width] duration-300 ease-in-out overflow-hidden group-data-[collapsible=icon]:opacity-0 group-data-[collapsible=icon]:max-w-0">
									{/* Room name and timestamp */}
