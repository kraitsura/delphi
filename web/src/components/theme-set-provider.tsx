...
const ThemeSetProviderContext = createContext<ThemeSetProviderState>(initialState)
...
export function ThemeSetProvider({
  ...
  useEffect(() => {
    ...
    root.classList.remove("theme-patagonia", "theme-redwood")
  ...
  const value = useMemo(
    ...
    [themeSet, setThemeSet, accent, setAccent, mode, setMode, resolvedMode, updateFromExternal]
  )
